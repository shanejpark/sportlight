        ...
        <div className="container w-75">
            <div className="row d-flex ms-5 me-5">
                ...
                <div className="col-lg d-flex align-items-center mb-5 ms-5">
                    <Image src="https://placehold.co/200x200" alt="league" thumbnail />
                    <div className='ms-5'>
                        <p>League Name</p>
                        <p>Season</p>
            ...
            <div className="row mt-5 ms-5 me-5">
                <div className="col-lg d-flex align-items-center mb-5">
                    <Image src="https://placehold.co/200x200" alt="home-team" thumbnail />
                    <div className='ms-5'>
                        <p>Home Team</p>
                        <Button variant="outline-secondary">+ Favorite</Button>{' '}
                    </div>
                ...
                <div className="col-lg d-flex align-items-center mb-5">
                    <Image src="https://placehold.co/200x200" alt="away-team" thumbnail />
                    <div className='ms-5'>
                        <p>Away Team</p>
                        <Button variant="outline-secondary">+ Favorite</Button>{' '}
                    </div>
