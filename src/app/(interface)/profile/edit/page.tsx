        ...
        <div className="container mt-5 w-50">
            ...
            <form>
                <div className="mb-3 mt-4">
                    ...
                    <input type="text" className="form-control mb-3" id="exampleInputName1" aria-describedby="nameHelp"
                        onChange={(e) => setAccount({
                            ...account,
                            firstName: e.target.value
                        })} 
                        value={account.firstName}/>
                    <label for="exampleInputName1" className="form-label">Last Name</label>
                ...
                <div className="mb-3">
                    ...
                    <select className="form-select" aria-label="Default select example" onChange={(e) => setAccount({
                            ...account,
                ...
                <div className="mb-5">
                    ...
                    <textarea class="form-control" id="exampleInputBio1" rows="3" onChange={(e) => setAccount({
                            ...account,
                            bio: e.target.value
                        })}
                ...
                <div className="mb-3 mt-5">
                    ...
                    <input type="text" className="form-control" id="exampleInputPhone1" aria-describedby="phoneNumberHelp" maxLength={10}
                    onChange={(e) => setAccount({
                        ...account,
